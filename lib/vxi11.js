...
function vxiSend(clink, clbk) {
  ...
  client.once('data', function(data) {
    ...
    var l =  clink.command.length;
    var cmdBufLen = l % 4 ? l + 4 - l % 4 : l;// multiple of 4 Bytes
    var cmdBuf = new Buffer(cmdBufLen);
    cmdBuf.fill(0);
    new Buffer(clink.command, 'ascii').copy(cmdBuf);
    ...
    client.write(getBuffer(clink, 'DEVICE_WRITE call', a, cmdBuf));
  });
